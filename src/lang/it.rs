...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Light", "Chiaro"),
        ("Follow System", ""),
        ("Enable hardware codec", "Abilita codifica hardware"),
        ("Unlock Security Settings", "Sblocca le impostazioni di sicurezza"),
        ("Enable Audio", "Abilita audio"),
        ("Temporary Password Length", ""),
        ("Unlock Network Settings", "Sblocca le impostazioni di rete"),
        ("Server", ""),
        ("Direct IP Access", "Accesso diretto IP"),
        ("Proxy", ""),
        ("Port", "Porta"),
        ("Apply", "Applica"),
        ("Disconnect all devices?", "Disconnettere tutti i dispositivi?"),
        ("Clear", ""),
        ("Audio Input Device", "Dispositivi di input audio"),
        ("Deny remote access", "Vieta l'accesso remoto"),
        ("Use IP Whitelisting", ""),
        ("Network", "Rete"),
        ...
        ("Stop session recording", "Ferma la registrazione della sessione"),
        ("Enable Recording Session", "Abilita registrazione della sessione"),
        ("Allow recording session", "Consenti registrazione della sessione"),
        ...
        ("Other", "Altro"),
        ("Confirm before closing multiple tabs", "Conferma prima di chiudere tab mutipli"),
        ...
        ("Elevate", ""),
        ("Zoom cursor", "Ingrandisci cursore"),
    ].iter().cloned().collect();
}
